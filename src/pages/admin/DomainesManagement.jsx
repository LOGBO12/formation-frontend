        ...
        <Container fluid className="py-3">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex align-items-center">
              ...
              <div>
                <h4 className="mb-0 fw-bold">Gestion des Domaines</h4>
                <small className="text-muted">Gérer les catégories de formations</small>
              </div>
            </div>
...
export default DomainesManagement;